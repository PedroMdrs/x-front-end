...
const contractAddress = "0x515EB95Fab6ac52CbE4fEC151aaC54AD42060e03";
...
const createPost = async () => {
  ...
  try {
    ...
    console.log(
      "Número total de posts antes de ser criado um novo:",
      Number(count)
    );
    ...
    console.log(
      "Número total de posts depois de ser criado um novo:",
      Number(count)
    );
  } catch (error) {
    console.log(error);
